...
class N2V_DataGenerator():
    ...
    def generate_patches_from_list(self, data, num_patches_per_img=None, shape=(512, 512), augment=True, shuffle=False):
        """
    ...
    def generate_patches(self, data, num_patches=None, shape=(512, 512), augment=True):
        """
    ...
    def __extract_patches__(self, data, num_patches=None, shape=(512, 512), n_dims=2):
        if num_patches == None:
            patches = []
            if n_dims == 2:
